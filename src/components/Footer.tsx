...
export default function Footer() {
  ...
  return (
    <footer className="bg-zinc-50 border-t border-zinc-200 pt-16 pb-8 dark:bg-zinc-950 dark:border-zinc-800">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-1">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed">
              Empowering businesses through intelligent automation and data-driven insights. Built for the future of work.
            </p>
          </div>
          
          <div>
            <h5 className="font-bold text-zinc-900 dark:text-white mb-6">Product</h5>
          ...
          <div>
            <h5 className="font-bold text-zinc-900 dark:text-white mb-6">Company</h5>
            <ul className="space-y-4 text-sm text-zinc-600 dark:text-zinc-400">
          ...
          <div>
            <h5 className="font-bold text-zinc-900 dark:text-white mb-6">Connect</h5>
            <div className="flex space-x-4">
              <Link href="#" className="w-10 h-10 rounded-full bg-zinc-200 flex items-center justify-center text-zinc-600 hover:bg-indigo-600 hover:text-white transition-all dark:bg-zinc-800 dark:text-zinc-400">
        ...
        <div className="pt-8 border-t border-zinc-200 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 dark:border-zinc-800">
          <p className="text-zinc-500 text-sm dark:text-zinc-500">
            &copy; {currentYear} SkylineAI. All rights reserved.
          </p>
          <div className="flex space-x-6 text-sm text-zinc-500 dark:text-zinc-500">
